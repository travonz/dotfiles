...
mynetworkmenu = awful.menu({ items = {
    { "&i Disconnect",    function () awful.util.spawn("sudo /home/bin/disconnect") end, "/home/xavier/.config/awesome/themes/travonz/icons/disconnect.svg"},
    { "&o Connect internet", function () awful.util.spawn("sudo /home/bin/connectInternet") end, "/home/xavier/.config/awesome/themes/travonz/icons/connect.svg"},
...
awful.screen.connect_for_each_screen(function(s)
    ...
    elseif s.index==2 then
        local names = { "[1]","[2]", "[3]", "[4]", "[5]", "[6]", "[7]" }
        local l = awful.layout.suit
        local layouts = { l.tile, l.tile, l.tile, l.tile.bottom, l.tile, l.tile, l.tile}
        awful.tag(names, s, layouts)
    end
